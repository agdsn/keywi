...
INSERT INTO key(number, lock_id, safe_id, rentable) VALUES (2, (SELECT id FROM lock LIMIT 1), (SELECT id FROM safe LIMIT 1), false),
                                                 (3, (SELECT id FROM lock LIMIT 1), (SELECT id FROM safe LIMIT 1), true);