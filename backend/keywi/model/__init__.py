from sqlalchemy import String, Column, Numeric, ForeignKey, Boolean, DateTime, CheckConstraint, Integer, func, Float
...
class Rental(UUIDModel):
    ...
    issuing_user = relationship("User", backref=backref("rentals"), primaryjoin="Rental.issuing_user_id == User.id")
